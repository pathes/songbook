(function() {
    ...
    angular.module('sbAuth', ['ngResource'])
        ...
        .factory('sbAuth', function ($resource) {
            ...
            var storedData = {
                username: window.username  // can be generated by django template
            };
            ...
            return {
                ...
                login: function (credentials) {
                    Auth.login(credentials).$promise
                        .then(function () {
                            storedData.username = credentials.username;
                            storedData.error = undefined;
                        })
                        .catch(function (error) {
                            storedData.error = error.data.detail;
                        });
                },
                logout: function () {
                    Auth.logout(function() {
                        storedData.username = undefined;
                    });
                }
            };
        })
